...
echo.
echo Where platform is one of 'djgpp' or 'mingw32', and 'none' to go back again
echo to the original makefile.
echo.
goto end

:ooes_error
echo Not enough memory to set the variables.
goto end
...
echo -include $(OBJ_DIR)/makefile.dep>> makefile
goto done
